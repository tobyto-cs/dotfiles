return {
  {
    ...
    config = function()
      ...
      local Diagnostics = {
        ...
        static = {
          error_icon = require("config.constants").icons.diagnostics.Error,
          warn_icon = require("config.constants").icons.diagnostics.Warn,
          info_icon = require("config.constants").icons.diagnostics.Info,
          hint_icon = require("config.constants").icons.diagnostics.Hint,
        },
